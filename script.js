...
let songs = [
    ...
    },
    {
        ...
        lyrics: [
            ...
            { time: 195.3, text: "Cover all of the sadness" },
            { time: 199.8, text: "I don't feel something special" },
            { time: 203, text: "Turn off the phone to get some spatial" },
            { time: 206.8, text: "Never thought I'd living in true" },
            { time: 212, text: "The truth that has been so blue" },
            { time: 216, text: "It was in a blink of an eye" },
    ...
    },
    {
        ...
        artist: "IV of Spades",
        album: "AM",
        albumArtUrl: "https://i.scdn.co/image/ab67616d0000b2731aaed2d9bea791b5488e08a2",
        audioSrc: "audio/Mundo - IV Of Spades.mp3",
        videoBgSrc: "videos/IV_OF_SPADES_-_Mundo.mp4",
        lyrics: [
            { time: 34.5, text: "Sa'n darating ang mga salita" },
            { time: 100, text: "Na nanggagaling sa aming dalawa?" },
            { time: 100, text: "Kung lumisan ka, 'wag naman sana" },
            { time: 150, text: "Ika'y kumapit na nang hindi makawala" },

            { time: 200, text: "Aking sinta" },
            { time: 250, text: "Ikaw na ang tahanan at mundo" },
            { time: 300, text: "Sa pagbalik" },
            { time: 350, text: "Mananatili na sa piling mo" },
            { time: 40, text: "Mundo'y magiging ikaw" },

            { time: 45, text: "'Wag mag-alala kung nahihirapan ka" },
            { time: 50, text: "Halika na, sumama ka, pagmasdan ang mga tala" },
            
            { time: 55, text: "Aking sinta" },
            { time: 60, text: "Ikaw na ang tahanan at mundo" },
            { time: 65, text: "Sa pagbalik" },
            { time: 70, text: "Mananatili na sa piling mo" },
            { time: 75, text: "Mundo'y magiging ikaw" },

            { time: 80, text: "Limutin na ang mundo" },
            { time: 85, text: "Nang magkasama tayo" },
            { time: 90, text: "Sunod sa bawat galaw" },
            { time: 95, text: "Hindi na maliligaw" },
            { time: 100, text: "Hindi na maliligaw" },

            { time: 105, text: "Hindi na maliligaw" },
            { time: 110, text: "Hindi na maliligaw" },
            { time: 115, text: "Hindi na maliligaw" },
            { time: 120, text: "Hindi na maliligaw" },
            { time: 125, text: "'Di na maliligaw, hindi na maliligaw" },
            { time: 130, text: "Hindi na maliligaw, hindi na maliligaw" },

            { time: 135, text: "Aking sinta" },
            { time: 140, text: "Ikaw na ang tahanan at mundo (mundo'y magiging ikaw)" },
            { time: 145, text: "Sa pagbalik" },
            { time: 150, text: "Mananatili na sa piling mo (mundo'y magiging ikaw)" },

            { time: 155, text: "Aking sinta (limutin na ang mundo)" },
            { time: 160, text: "Ikaw na ang tahanan at mundo (nang magkasama tayo)" },
            { time: 165, text: "(Mundo'y magiging ikaw)" },
            { time: 170, text: "Sa pagbalik (sunod sa bawat galaw)" },
            { time: 175, text: "Mananatili na sa piling mo (hindi na maliligaw)" },
            { time: 180, text: "Mundo'y magiging ikaw" },

            { time: 185, text: "Limutin na ang mundo" },
            { time: 190, text: "Nang magkasama tayo" },
            { time: 195, text: "Sunod sa bawat galaw" },
            { time: 200, text: "Hindi na maliligaw" },
            { time: 205, text: "Mundo'y magiging ikaw" }
        ]
    },
